...
out_dir = "/data/RBL_NCI/Wolin/Phil/mESC_clip/Novo_UMI_split/bam_icountprocess/mm10_Gencode_rRNA/iCount_all"
...
script += "\n"
script += "\n"
script += "samtools merge "+out_dir+"/Ro_Clip_iCountcutadpt_all.sam "
